    ...
    >
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center">
        <img
          ...
          className="w-full h-[300px] sm:h-[400px] lg:h-screen object-cover"
        />
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-10 py-10 lg:py-0">
        <div className="relative mb-6">
          <span className="text-[80px] sm:text-[120px] md:text-[150px] lg:text-[180px] font-bold text-white opacity-10">
            {count}
          </span>
        ...
        <button className="mt-6 text-yellow-400 font-semibold flex items-center gap-2 hover:underline text-sm sm:text-base">
          read more
