...
const LandingPage = () => {
  return (
    <div data-aos="fade-up" className="w-full bg-[#0B1D26]">
      <div className="relative w-full min-h-screen text-white">
        <div className="absolute top-0 left-0 w-full h-full z-0 "> 
          ...
          <img
            src={img2}
            alt="Image 2"
            className="absolute md:top-[330px] top-[140px] left-0 w-full object-cover"
          />
          <img
            src={img3}
            alt="Image 3"
            className="absolute md:top-[560px] top-[240px] left-0 w-full object-cover md:h-full "
          />
      ...
      <section className="relative z-10 md:py-20 py-5 px-6">
        <div className="flex flex-col md:space-y-32 space-y-4">
